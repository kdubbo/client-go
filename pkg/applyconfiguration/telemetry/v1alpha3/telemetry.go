...
type TelemetryApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *telemetryv1alpha3.Telemetry `json:"spec,omitempty"`
...
func Telemetry(name, namespace string) *TelemetryApplyConfiguration {
	...
	b.WithAPIVersion("telemetry.dubbo.apache.org/v1alpha3")
	return b
}
...
func (b *TelemetryApplyConfiguration) WithSpec(value telemetryv1alpha3.Telemetry) *TelemetryApplyConfiguration {
	b.Spec = &value
	return b
}
...
func (b *TelemetryApplyConfiguration) WithStatus(value v1alpha1.DubboStatus) *TelemetryApplyConfiguration {
	b.Status = &value
	return b
}
