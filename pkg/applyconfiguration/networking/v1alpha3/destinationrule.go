...
import (
	...
	v1alpha3 "github.com/kdubbo/api/networking/v1alpha3"
...
func (b *DestinationRuleApplyConfiguration) WithStatus(value v1alpha1.DubboStatus) *DestinationRuleApplyConfiguration {
	b.Status = &value
	return b
}
