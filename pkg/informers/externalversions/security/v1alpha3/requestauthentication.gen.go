...
type RequestAuthenticationInformer interface {
	...
	Lister() securityv1alpha3.RequestAuthenticationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SecurityV1alpha3().RequestAuthentications(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SecurityV1alpha3().RequestAuthentications(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SecurityV1alpha3().RequestAuthentications(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SecurityV1alpha3().RequestAuthentications(namespace).Watch(ctx, options)
			},
		},
		&apissecurityv1alpha3.RequestAuthentication{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *requestAuthenticationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apissecurityv1alpha3.RequestAuthentication{}, f.defaultInformer)
}

func (f *requestAuthenticationInformer) Lister() securityv1alpha3.RequestAuthenticationLister {
	return securityv1alpha3.NewRequestAuthenticationLister(f.Informer().GetIndexer())
}
